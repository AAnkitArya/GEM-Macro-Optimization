...
# Portable repo root: prefer git (works from any checkout on any machine,
# including the judges'), fall back to "two levels up from this script"
# if the tree is used outside of git (e.g. extracted from a submission zip).
